...
export const en = {
  ...
  'admin.guestLinksTitle': 'Guest links',
  'admin.guestLinksHint': 'A guest link lets someone answer this quiz with no account — every visit records a new response.',
  'admin.guestLinkModeLabel': 'Mode',
  'admin.guestLinkModeTest': 'Test (scored, correct answer revealed)',
  'admin.guestLinkModeSurvey': 'Survey (no correct/incorrect ever shown)',
  'admin.guestLinkLabelPlaceholder': 'Link name (optional)',
  'admin.createGuestLinkButton': '➕ Create a link',
  'admin.errorCreateGuestLink': 'Could not create this link.',
  'admin.errorLoadGuestLinks': 'Could not load guest links.',
  'admin.errorDeleteGuestLink': 'Could not delete this link.',
  'admin.noGuestLinks': 'No guest links for this quiz yet.',
  'admin.guestLinkUnlabeled': 'Unnamed',
  'admin.guestLinkCopyButton': '📋 Copy link',
  ...
  'admin.guestResultsShow': '📊 View results',
  'admin.guestResultsHide': 'Hide results',
  'admin.guestResultsErrorLoad': 'Could not load the results.',
  'admin.guestResultsEmpty': 'No responses received yet.',
  'admin.guestResultsCount': 'Responses',
  'admin.guestResultsAverageScore': 'Average score',
  'admin.guestResultsAverageTime': 'Average time',
  'admin.guestResultsPerQuestion': 'Breakdown by question',
  'admin.guestResultsCorrectRate': (correct: number, total: number, rate: number) => `${correct} / ${total} correct (${rate}%)`,
  'admin.guestResultsReceived': 'Responses received',
  ...
  'auth.login': 'Log in',
  'guest.invalidLink': 'This link is not valid or has been revoked.',
  'guest.introTest': 'Scored test: your result will be recorded and you will see the correction at the end.',
  'guest.introSurvey': 'Survey: your answers will be recorded, no correction will be shown.',
  'guest.questionCount': (count: number) => `${count} question${count !== 1 ? 's' : ''}`,
  'guest.nameLabel': 'Your name',
  'guest.namePlaceholder': 'First and last name',
  'guest.start': 'Start',
  'guest.finish': 'Finish',
  'guest.submitting': 'Sending…',
  'guest.errorSubmit': 'Could not record your answers. Check your connection and try again.',
  'guest.thanksTitle': 'Thank you!',
  'guest.thanksTest': (name: string) => `${name}, your test has been recorded.`,
  'guest.thanksSurvey': 'Your answers have been recorded. You can close this page.',
